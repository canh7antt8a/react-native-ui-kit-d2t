...
class Card extends PureComponent {
  ...
  render() {
    ...
    }, this.elevationStyle, this.shadowStyle, this.blurBgStyle, containerStyle, style]} onPress={onPress} onLongPress={onLongPress} delayPressIn={10} activeOpacity={0.6} accessibilityState={{
      selected
    }} {...others} ref={forwardedRef}>
        {Constants.isIOS && enableBlur && // @ts-ignore

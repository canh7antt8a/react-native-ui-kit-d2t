...
class Badge extends PureComponent {
  ...
  renderIcon() {
    ...
    return <Image source={icon} resizeMode="contain" //@ts-ignore
  ...
  render() {
    ...
    return (// The extra View wrapper is to break badge's flex-ness
      ...
      <View style={containerStyle} {...others} backgroundColor={undefined} borderWidth={undefined} {...this.getAccessibilityProps()}>
        <Container testID={testID || testId} pointerEvents={'none'} style={[sizeStyle, this.styles.badge, borderStyle, backgroundStyle]} onPress={onPress} activeOpacity={activeOpacity} hitSlop={hitSlop} {...animationProps}>
